...
%-------------------------------------------------%
%AXIS Primer bloque.
pks=6; %Deberia ser el numero de celulas con correlaciones significativas para un experimento dado 
...
csi_cut=0.15; %Hacer una funcion para tomar diferentes valores y luego hacer cross-validation
