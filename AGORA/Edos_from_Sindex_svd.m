...
S_svd_sig=S_svd;
edos_size_cut=20; %Para determinar el numero de edos a partir de plot(sum(S_svd))
...
edos_svd_cut=0.8; %Corte para los factores del svd. Pensar en una manera de normalizar
svd_fac=(svd_fac>edos_svd_cut)*1;
% implay(svd_fac); %Para visualizar los factores como pelicula
rep_svd=30; %Encuentra los repetidos mas de n^2 veces
